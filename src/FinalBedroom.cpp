...
FinalBedroom::FinalBedroom() {
	exit.x = 708; 
	exit.y = 38; 
	exit.w = 132; 
	exit.h = 330; 
	image = Functions::loadImage("bedroom2.jpg");
}

SDL_Event FinalBedroom::handleEvents(SDL_Event event, Game* g) {
    //The mouse offsets
    int x = 0, y = 0;
